...
<x-intranet-app-cisco::cisco-layout heading="Cisco App" subheading="Admin">
    <flux:tab.group>
        ...
        <flux:tab.panel name="einstellungen">
            <div style="min-height: 400px;">
                @livewire('intranet-app-base::admin-settings', [
                    'appIdentifier' => 'cisco',
                    'settingsModelClass' => '\Hwkdo\IntranetAppCisco\Models\IntranetAppCiscoSettings',
                    'appSettingsClass' => '\Hwkdo\IntranetAppCisco\Data\AppSettings'
                ])
            </div>
        </flux:tab.panel>
            ...
            <div style="min-height: 400px;">
                <flux:card>
                    ...
                    <flux:text class="mb-6">
                        Übersicht über die Nutzung der Cisco App.
                    </flux:text>
