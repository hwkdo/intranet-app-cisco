...
title('Cisco - Beispiel');

state(['exampleData' => [
    'name' => 'Beispiel Item',
    'description' => 'Dies ist ein Beispiel-Item für die Cisco App',
    'status' => 'active',
...
<x-intranet-app-cisco::cisco-layout heading="Beispiel-Seite" subheading="Demonstration der Cisco-Funktionalität">
    <flux:card>
